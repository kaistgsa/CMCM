...
**제1조 (목적)**  
본 세칙은 제54대 KAIST 대학원 총학생회 총선거(이하 “총선거”라 한다.)를 민주적이고 공정하게 진행
...
2. 후보(총학생회장 및 부총학생회장 후보)는 재학 중 정학 이상의 징계처분을 받지 아니하여야 하며, 준회원 기록이 없는 자여야 한다.
...
**제16조 (선거일정의 수립)**  
① 본회는 회칙 제95조 제2항에 따라 선거일로부터 20일 이전에 선거일을 확정한다.  
...
**제19조 (선거인명부 작성)**  
① 중선관위는 선거권자를 조사하여 예비후보 공고일 23시 59분까지 선거인명부 작성을 KAIST 학생지원팀에 위탁하여 완성해야한다.  
...
**제20조 (선거인명부의 열람)**  
① 중선관위는 선거인명부 작성 다음 날부터 투표 개시 48시간 전까지 선거인명부를 열람할 수 있도록 하여야 한다.  
...
5. 실 투표수: 개표 시 온라인 투표 시스템에 최종 집계된 투표 건수의 합(유효투표수와 무효투표수를 포함한다).
...
② 온라인 투표는 카이스트 계정인증 방식을 이용하여 선거인 명부와의 대조를 진행한 상태에서 진행한다.

**제50조 (투표시간)**  
① 투표는 4일간 진행하며, 첫 번째 투표일 0시부터 네 번째 투표일 23시 59분까지 진행한다.  
② 중선관위와 각 선본이 모두 합의한다는 전제하에 투표시간을 연장할 수 있다.  

**제51조 (재선거)**  
① 다음 각 호의 경우 중선관위에서는 20일 이내에 재선거를 실시해야 한다.  
1. 연장투표까지 종료했음에도 투표율 요건을 충족하지 못한 경우
2. 단수 후보에서 투표율은 충족했으나 찬성 과반 요건을 충족하지 못한 경우


## 제11장 개표

**제52조 (개표)**  
① 모든 투표가 종료된 이후, 가 투표율이 20%(단수 후보 시 15%) 이상인 경우 중선관위는 개표를 진행한다.  
...
4. 단체 메시지 발송 상에서 수신자의 수신 거부 의사를 반영하지 않거나 발송 후 6시간 이내에 중선관위에 보고하지 않을 경우
...
**제1조 (시행일)** 본 세칙은 제54대 KAIST 대학원 총학생회 총선거 공고 후 효력이 발생한다.
